...
//    virtual void customizeScores() {
//        for (auto& semester : semesters) {
//            for (auto& course : semester) {
//                cout << "Customizing scores for course: " << course.subjectName << endl;
//                for (size_t i = 0; i < course.assignments.size(); ++i) {
//                    cout << "Current Assignment " << (i + 1) << " Score: " << course.assignments[i] << endl;
//                    cout << "Enter new score for Assignment " << (i + 1) << ": ";
//                    cin >> course.assignments[i];
//                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
//                }
//                for (size_t i = 0; i < course.tests.size(); ++i) {
//                    cout << "Current Test " << (i + 1) << " Score: " << course.tests[i] << endl;
//                    cout << "Enter new score for Test " << (i + 1) << ": ";
//                    cin >> course.tests[i];
//                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
//                }
//                cout << "Current Exam Score: " << course.exam << endl;
//                cout << "Enter new score for Exam: ";
//                cin >> course.exam;
//                cin.ignore(numeric_limits<streamsize>::max(), '\n');
//            }
//        }
...
void addStudent() {
    ...
    int numTests = (type == "Uni" || type == "uni") ? 2 : 1;
    ...
    if (type == "Uni" || type == "uni") {
        ...
        students[id] = new CollegeStudent(name, dob, schoolName, courseName, score, semesters);
    }
...
//void enterGrades() {
//    if (students.empty()) {
//        cout << "No students to enter grades for." << endl;
//        return;
//    }
//    for (const auto& pair : students) {
//        pair.second->customizeScores();
//    }
//    cout << "Grades updated.\n";
//}
